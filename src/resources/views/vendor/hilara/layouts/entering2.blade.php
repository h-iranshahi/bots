<html lang="en" dir="{{ currentLanguage('direction') }}" style="--primary01: rgba(143, 189, 86, 0.1); --primary02: rgba(143, 189, 86, 0.2); --primary03: rgba(143, 189, 86, 0.3); --primary06: rgba(143, 189, 86, 0.6); --primary09: rgba(143, 189, 86, 0.9);">
<head>
...
@livewireStyles()
    ...
    <body class="{{ currentLanguage('direction') }} login-img">
                            ...
                            <div class="skin-body">
                                <div class="switch_section">
                                    ...
                                    <div class="switch-toggle d-flex">
                                        ...
                                        <div class="">
                                            <input class="wpx-30 h-30 input-color-picker color-primary-light" value="#8FBD56" id="colorID" type="color" data-id="bg-color" data-id1="bg-hover" data-id2="bg-border" data-id7="transparentcolor" name="lightPrimary">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="skin-body">
                                <div class="switch_section">
                                    ...
                                    <div class="switch-toggle d-flex mt-2">
                                        ...
                                        <div class="">
                                            <input class="wpx-30 h-30 input-dark-color-picker color-primary-dark" value="#8FBD56" id="darkPrimaryColorID" type="color" data-id="bg-color" data-id1="bg-hover" data-id2="bg-border" data-id3="primary" data-id8="transparentcolor" name="darkPrimary">
                                        </div>
                                    </div>
                                    <div class="switch-toggle">
                                        <span class="">Background Image</span>
                                        <div class="mt-1">
                                            <a class="bg-img bg-img1" href="javascript:void(0);"><img src="{{ asset('vendor/hilara/noa/assets/images/media/bg-img1.jpg') }}" alt="Bg-Image" id="bgimage1"></a>
                                            <a class="bg-img bg-img2" href="javascript:void(0);"><img src="{{ asset('vendor/hilara/noa/assets/images/media/bg-img2.jpg') }}" alt="Bg-Image" id="bgimage2"></a>
                                            <a class="bg-img bg-img3" href="javascript:void(0);"><img src="{{ asset('vendor/hilara/noa/assets/images/media/bg-img3.jpg') }}" alt="Bg-Image" id="bgimage3"></a>
                                            <a class="bg-img bg-img4" href="javascript:void(0);"><img src="{{ asset('vendor/hilara/noa/assets/images/media/bg-img4.jpg') }}" alt="Bg-Image" id="bgimage4"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="page">
            <div>
                ...
                <div class="col col-login mx-auto text-center">
                    <a href="index.html">
                        <img src="{{ asset('vendor/hilara/images/logo-dark.png') }}" class="header-brand-img" alt="">
                    </a>
                </div>
